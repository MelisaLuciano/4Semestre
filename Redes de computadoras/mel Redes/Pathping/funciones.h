...
void obtenGATEWAY(GATEWAY,char*);
...
int obtenParametros(Datos *misDatos){
    ...
    obtenGATEWAY(misDatos->miGATEWAY,misDatos->nom_interfaz);
...
/*void obtenGATEWAY(GATEWAY miGATEWAY){
  char gate[50] = "192.168.1.254";
  IP_aton(gate,miGATEWAY);
}*/

void obtenGATEWAY(GATEWAY miGATEWAY,char *interface) {
  char *gateway = NULL;
